...
2. Open the actual toolbar popup. Use **Options → Import profile** with
   [local-profile.json](../examples/local-profile.json), or create a profile
...
![Live browser header test](../screenshots/header-check.jpg)
...
The detailed investigation history is [archived here](../qa/2026-09-12-test-history.md).
